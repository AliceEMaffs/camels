...
train_args = {
    "training_batch_size": 32,    # Keep
    "learning_rate": 5e-5,        # Reduce further
    "stop_after_epochs": 25,      # Stop earlier
    "max_num_epochs": 1000,
    "clip_max_norm": 2.0,         # More aggressive clipping
    "validation_fraction": 0.1, 
    "show_train_summary": True
}

hidden_features = 50   # Slightly reduce
num_transforms = 3    # Back to 2
num_nets = 2         # Keep ensemble
