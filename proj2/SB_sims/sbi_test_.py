...
model_params = f"batch{train_args['training_batch_size']}_"                f"lr{train_args['learning_rate']:.0e}_"                f"epochs{train_args['stop_after_epochs']}_"                f"val{train_args['validation_fraction']}_"                f"hidden{hidden_features}_"                f"transforms{num_transforms}"
